...
<body>
    ...
    <header>
        ...
        <div id="top-header">
            <div class="container">
                <div class="pull-left">
                    <span>Selamat datang di Web Ecommers Fauzi</span>
                </div>
            </div>
        </div>
        <!-- /top Header -->
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2 text-center">
                    ...
                    <div class="footer-copyright">
                        ...
                        </script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="" target="_blank">FAUZI</a>
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </div>
                    <!-- /footer copyright -->
                </div>
